...
The Generic Table in Apache Polaris is designed to provide support for non-Iceberg tables across different table formats includes delta, parquet, csv etc. It currently provides the following capabilities:
...
- **format** (required): The format for the generic table, i.e. "delta", "parquet", "csv"
