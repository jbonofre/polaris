...
@ApplicationScoped
public class PolarisServiceImpl implements PolarisCatalogsApiService, PolarisPrincipalsApiService, PolarisPrincipalRolesApiService {
    ...
    public Response assignPrincipalRole(
        ...
        LOGGER.info("Assigning principalRole {} to principal {}", request.getPrincipalRole().getName(), principalName);
        PolarisAdminService adminService = newAdminService(securityContext);
    ...
    public Response assignCatalogRoleToPrincipalRole(
            ...
            SecurityContext securityContext) {
        LOGGER.info("Assigning catalogRole {} in catalog {} to principalRole {}", request.getCatalogRole().getName(), catalogName, principalRoleName);
        PolarisAdminService adminService = newAdminService(securityContext);
    ...
    public Response revokeCatalogRoleFromPrincipalRole(
        ...
        LOGGER.info("Revoking catalogRole {} in catalog {} from principalRole {}",
                catalogRoleName, catalogName, principalRoleName);
        PolarisAdminService adminService = newAdminService(securityContext);
    ...
    public Response addGrantToCatalogRole(
            ...
            SecurityContext securityContext) {
        LOGGER.info("Adding grant {} to catalogRole {} in catalog {}",
                grantRequest, catalogRoleName, catalogName);
        PolarisAdminService adminService = newAdminService(securityContext);
    ...
    public Response revokeGrantFromCatalogRole(
            ...
            SecurityContext securityContext) {
        LOGGER.info("Revoling grant {} from catalogRole {} in catalog {}",
                grantRequest, catalogRoleName, catalogName);
